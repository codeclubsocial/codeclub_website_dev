    ...
    if (Object.keys(this.state.meetupJson).length !== 0) {
      ...
      return (
        <div>
          ...
          <form action="https://secure.meetup.com/oauth2/authorize?client_id=kksoj0htpfk9ef9c5qcphj0glv&response_type=code&redirect_uri=http://austinsandbox.herokuapp.com/index">
